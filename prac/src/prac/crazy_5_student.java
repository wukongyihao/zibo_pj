	...
	public static void Select() {
		...
		for(;i<stu_list.length;i++) {
			if(num.equals(stu_list[i].name)) {
					...
					System.out.println("没有查到"+num+"的用户");
					return;
				}
			}
	}
...
//		int i = 0;
		...
		student stu1 = new student(12,"小明","男","12312341234","北京","123@123.com");
		student stu2 = new student(22,"小明1","男","12312341234","北京","1234@123.com");
